function premierDash() {
    ...
    window.location = '../dashs/premier.html';
}

function laligaDash() {
    sessionStorage.setItem("LIGA_ATUAL", "La Liga");
    window.location = '../dashs/laliga.html';
}
